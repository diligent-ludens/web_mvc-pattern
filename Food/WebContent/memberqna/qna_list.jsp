...
<%
	List<QnaDTO> qnaList=(List<QnaDTO>)request.getAttribute("qnalist2");
	int listcount=((Integer)request.getAttribute("listcount2")).intValue();
	int nowpage=((Integer)request.getAttribute("page2")).intValue();
	int maxpage=((Integer)request.getAttribute("maxpage2")).intValue();
	int startpage=((Integer)request.getAttribute("startpage2")).intValue();
	int endpage=((Integer)request.getAttribute("endpage2")).intValue();	
%>
<!DOCTYPE html>
<html>
<head>
	...
	%>	
		<tr>
			...
			<%}else{ %>
				▶
			<%} %>
			<a href="./MemberQnaDetailAction.me?num=<%=bl.getQNA_NUM()%>">
				<%=bl.getQNA_SUBJECT()%>
			</a>
			</div>
			</td>
...
%>
	<tr align="right">
		<td colspan="5">
	   		<a href="./MemberQnaWrite.me">[글쓰기]</a>
		</td>
	</tr>
