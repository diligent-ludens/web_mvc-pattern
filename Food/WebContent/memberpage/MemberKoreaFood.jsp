...
<body>
	...
	<table id="top" style="margin-left:auto; margin-right:auto;">
		...
		<tr>
			...
			<!-- member 전용 -->
			<td><a href="./DetailWrite.ag">맛집 등록</a></td>
		</tr>
	</table>
	...
	<table style="margin-left:auto; margin-right:auto;">
		<tr align=center height=20>
			<td style=font-family:Tahoma;font-size:10pt;>
				...
				[이전]&nbsp;
				<%}else{ %>
				<a href="./MemberKoreaFood.me?page=<%=nowpage-1 %>">[이전]</a>&nbsp;
				<%} %>
				...
				<%for(int a=startpage;a<=endpage;a++){
					...
					[<%=a %>]
					<%}else{ %>
					<a href="./MemberKoreaFood.me?page=<%=a %>">[<%=a %>]</a>&nbsp;
					<%} %>
				<%} %>
				...
				[다음]
				<%}else{ %>
				<a href="./MemberKoreaFood.me?page=<%=nowpage+1 %>">[다음]</a>
				<%} %>
			</td>
		</tr>
		<%
